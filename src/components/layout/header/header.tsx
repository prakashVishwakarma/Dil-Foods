...
const Header: React.FC = () => {
	...
	return (
		...
		>
			<div className="innerSticky text-gray-700 body-font fixed bg-red-300 w-full h-16 sm:h-20 lg:h-24 z-20 ps-4 md:ps-0 lg:ps-6 pe-4 lg:pe-6 transition duration-200 ease-in-out">
